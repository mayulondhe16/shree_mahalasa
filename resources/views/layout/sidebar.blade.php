<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="/public/dashbord" target="_blank">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="{{url('/')}}/manage_city">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="{{url('/')}}/manage_shade">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="{{url('/')}}/manage_main_category">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="{{url('/')}}/manage_category">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="{{url('/')}}/manage_aboutus">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="{{url('/')}}/manage_contactdetails">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="{{url('/')}}/manage_quicklinks">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="{{url('/')}}/manage_socialmedialinks">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="{{url('/')}}/manage_newsletter">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="{{url('/')}}/manage_shops">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="{{url('/')}}/manage_top_selling">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
